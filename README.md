...
|----------|----------|------|-------|---------|
| Compressed VCF + .tbi (tabix) | 241.11s (1×) | 12.91s (18.7×) | 8.54s (28.2×) | **7.11s (33.9×)** |
| Compressed VCF + no index (bgzip) | 241.11s (1×) | 14.80s (16.3×) | 14.81s (16.3×) | 14.88s (16.2×) |
| Uncompressed VCF (12 GB) | 218.51s (1×) | 9.69s (22.6×) | 6.65s (32.9×) | **5.52s (39.6×)** |
