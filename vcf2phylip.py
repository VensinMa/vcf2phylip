...
from file bytes; selects optional ISA-L, zlib-ng, bgzip, or tabix backends;
and parses genotype chunks with multiple worker processes. Indexed BGZF VCFs
...
def main():
    ...
    parser.add_argument(
        ...
        choices=("auto", "plain", "stdlib", "isal", "zlib-ng", "bgzip", "tabix"),
